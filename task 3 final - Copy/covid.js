...
// access data by country name

var form=document.getElementById('form');
form.addEventListener('submit',function(e)
{ 
e.preventDefault() 
var country=document.getElementById('texts').value;
    var link="https://api.covid19api.com/total/dayone/ntry/"+country; 
  fetch(link)
  .then((res)=>res.json())  
  .then((res)=> {    
    console.log(res)  
    ...
    var index=length-1 
    var confirmed=document.ClassName('confirmed')
    var recovered=document.ClassName('recovered')  
    var deaths=document.ClassName('deaths')
    var active=document.ClassName('active')
...
var row = `<tr>
<td>${array[i].country_name}</td>
<td>${array[i].cases}</td>
<td>${array[i].deaths}</td>
<td>${array[i].region}</td>
<td>${array[i].total_recovered}</td>
<td>${array[i].new_deaths}</td>
<td>${array[i].new_cases}</td>  
<td>${array[i].serious_critical}</td>
<td>${array[i].active_cases}</td>
<td>${array[i].total_cases_per_1m_population}</td>
